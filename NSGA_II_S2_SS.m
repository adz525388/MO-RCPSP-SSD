function [ activity_pop, worker_pop, pobje, managerial_cost_S2 ] = NSGA_II_S2_SS( population_size, number_of_activity, single_skill_set_of_worker,...
...
% Initialization
[ first_p_activity, first_p_worker ] = initialization_S2( population_size, number_of_activity, single_skill_set_of_worker,...
...
[ tutobje, managerial_cost_S2 ] = fitness_function_S2( p_activity, p_worker, single_HT_worker_cost, population_size, number_of_worker, number_of_activity,...
...
[ tutobje ] = fitness_function_S2( p_activity, p_worker, single_HT_worker_cost, population_size, number_of_worker, number_of_activity,...
                                            swc_single, predecessor_matrix, number_of_skill, task_time_of_each_skill, single_HT_proficiency_level,total_skill_number);
qobje = tutobje;
