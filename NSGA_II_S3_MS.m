function [ activity_pop, worker_pop, pobje, managerial_cost_S3 ] = NSGA_II_S3_MS( population_size, number_of_activity, multi_skill_set_of_worker,...
...
% Initialization
[ first_p_activity, first_p_worker ] = initialization_S3( population_size, number_of_activity, multi_skill_set_of_worker,...
...
[ tutobje, managerial_cost_S3 ] = fitness_function_S3( p_activity, p_worker, multi_HT_worker_cost, population_size, number_of_worker, number_of_activity,...
...
[ tutobje ] = fitness_function_S3( p_activity, p_worker, multi_HT_worker_cost, population_size, number_of_worker, number_of_activity,...
                                            swc_multi, predecessor_matrix, number_of_skill, task_time_of_each_skill, multi_HT_proficiency_level,total_skill_number);
qobje = tutobje;
